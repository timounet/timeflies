...
CREATE ROLE chef WITH LOGIN PASSWORD 'chef' NOSUPERUSER INHERIT NOCREATEDB NOCREATEROLE NOREPLICATION;
CREATE DATABASE projects_database;
GRANT ALL PRIVILEGES ON DATABASE projects_database TO chef;
